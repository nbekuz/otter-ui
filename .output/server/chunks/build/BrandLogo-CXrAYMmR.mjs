...
import { B as BRAND_NAME, c as useSettingsStore } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><img${ssrRenderAttr("src", unref(logoUrl))}${ssrRenderAttr("alt", `${unref(BRAND_NAME)} logo`)} class="${ssrRenderClass([unref(logoClass), unref(logoToneClass)])}"><span class="${ssrRenderClass([nameClassMap[__props.showNameFrom], __props.textClass, unref(textSizeClass), "font-bold tracking-tight"])}">${ssrInterpolate(__props.name)}</span></div>`);
    };
  }
});
...
//# sourceMappingURL=BrandLogo-CXrAYMmR.mjs.map
