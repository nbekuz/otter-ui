...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex min-h-dvh w-full flex-col overflow-x-hidden bg-white" }, _attrs))}><div class="flex flex-1 flex-col lg:h-dvh lg:max-h-dvh lg:justify-center lg:overflow-y-auto lg:py-3 xl:py-4"><div class="w-full px-4 pt-4 pb-6 md:px-8 md:pt-6 md:pb-8 lg:grid lg:grid-cols-[1.02fr_0.98fr] lg:items-center lg:gap-8 lg:px-8 lg:py-0 xl:gap-10 xl:px-12"><div class="flex w-full flex-col items-center justify-start md:items-stretch lg:items-start"><div class="relative mb-4 w-fit lg:mb-3">`);
      _push(ssrRenderComponent(_component_BrandLogo, {
        size: "md",
        "show-name-from": "always",
        "text-class": "text-sber-black lg:text-2xl"
      }, null, _parent));
      _push(`</div><p class="mb-0 w-full text-center text-base leading-relaxed text-sber-gray md:text-left lg:max-w-xl lg:text-lg lg:leading-snug"> \u041F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0449\u0438\u043A \u0437\u0430\u0434\u0430\u0447 \u0434\u043B\u044F \u0442\u0435\u0445, \u043A\u0442\u043E \u0446\u0435\u043D\u0438\u0442 \u0432\u0440\u0435\u043C\u044F </p><div class="mt-5 grid w-full grid-cols-1 gap-3 md:grid-cols-2 lg:mt-4 lg:gap-3"><!--[-->`);
      ssrRenderList(features, (feature) => {
        _push(`<div class="flex items-start gap-3 rounded-[20px] bg-sber-gray-light px-4 py-3.5 text-left shadow-sm lg:rounded-[18px] lg:px-3.5 lg:py-3"><div class="${ssrRenderClass([feature.bg, "flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl text-lg lg:h-9 lg:w-9"])}">${ssrInterpolate(feature.icon)}</div><div class="min-w-0"><p class="text-sm font-semibold text-sber-black lg:text-[15px]">${ssrInterpolate(feature.title)}</p><p class="mt-0.5 text-xs leading-5 text-sber-gray lg:text-[13px]">${ssrInterpolate(feature.text)}</p></div></div>`);
      });
      _push(`<!--]--></div>`);
      _push(ssrRenderComponent(_component_LandingPremiumBlock, { class: "mt-3 lg:mt-3" }, null, _parent));
      _push(`</div><div class="w-full max-w-none pt-4 pb-2 md:pt-6 lg:pt-0 lg:pb-0"><div class="w-full rounded-[28px] bg-sber-gray-light p-5 md:p-6 lg:p-5 xl:p-6"><p class="text-sm font-semibold text-sber-green">\u041F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u0435, \u0444\u043E\u043A\u0443\u0441 \u0438 \u043F\u043E\u0440\u044F\u0434\u043E\u043A</p><h2 class="mt-2 text-xl font-bold text-sber-black lg:text-2xl lg:leading-tight"> \u0412\u0441\u0435 \u043E\u0441\u043D\u043E\u0432\u043D\u044B\u0435 \u0438\u043D\u0441\u0442\u0440\u0443\u043C\u0435\u043D\u0442\u044B \u0434\u043B\u044F \u0440\u0430\u0431\u043E\u0442\u044B \u0441 \u0437\u0430\u0434\u0430\u0447\u0430\u043C\u0438 \u0432 \u043E\u0434\u043D\u043E\u043C \u043C\u0435\u0441\u0442\u0435. </h2><p class="mt-2 text-sm leading-6 text-sber-gray lg:max-w-md lg:text-[15px]"> \u0412\u0435\u0434\u0438\u0442\u0435 \u0441\u043F\u0438\u0441\u043A\u0438 \u0437\u0430\u0434\u0430\u0447, \u043F\u043B\u0430\u043D\u0438\u0440\u0443\u0439\u0442\u0435 \u0432\u0440\u0435\u043C\u044F \u0432 \u043A\u0430\u043B\u0435\u043D\u0434\u0430\u0440\u0435, \u0440\u0430\u0441\u0441\u0442\u0430\u0432\u043B\u044F\u0439\u0442\u0435 \u043F\u0440\u0438\u043E\u0440\u0438\u0442\u0435\u0442\u044B \u0438 \u0441\u043E\u0445\u0440\u0430\u043D\u044F\u0439\u0442\u0435 \u0444\u043E\u043A\u0443\u0441 \u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0435 \u0434\u043D\u044F. </p><div class="relative mt-4 grid grid-cols-2 items-start gap-2 sm:gap-3 lg:mt-4"><!--[-->`);
      ssrRenderList(metrics, (metric, index) => {
        _push(`<div class="${ssrRenderClass([{ "sm:mt-6 lg:mt-5": index % 2 === 1 }, "flex min-h-[88px] min-w-0 items-center justify-center rounded-2xl bg-white px-2 py-3 text-center shadow-sm sm:px-3 lg:min-h-[76px]"])}"><p class="w-full min-w-0 text-balance text-center text-[11px] font-bold uppercase leading-tight tracking-tight text-sber-black sm:text-sm lg:text-[13px]">${ssrInterpolate(metric)}</p></div>`);
      });
      _push(`<!--]--><div class="pointer-events-none absolute left-1/2 top-1/2 z-10 flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-sber-gray-light lg:h-14 lg:w-14"><div class="flex h-11 w-11 items-center justify-center rounded-full bg-white shadow-sm lg:h-10 lg:w-10"><img${ssrRenderAttr("src", unref(logoUrl))}${ssrRenderAttr("alt", `${unref(BRAND_NAME)} logo`)} class="h-7 w-7 brightness-0 lg:h-6 lg:w-6"></div></div></div><div class="mt-4 flex w-full flex-col items-center gap-2 lg:mt-4"><div class="flex w-full flex-wrap justify-center gap-2"><button class="btn-primary !w-auto min-w-0 shrink px-4 sm:px-6" type="button"> \u0421\u043E\u0437\u0434\u0430\u0442\u044C \u0430\u043A\u043A\u0430\u0443\u043D\u0442 </button><button class="btn-outline !w-auto min-w-0 shrink px-4 sm:px-6" type="button"> \u0412\u043E\u0439\u0442\u0438 </button></div><div class="flex w-full flex-col items-center gap-2">`);
...
//# sourceMappingURL=index-BZm4IW6S.mjs.map
