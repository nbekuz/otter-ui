...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="flex-1" data-v-c921ae33><div class="flex items-center gap-2" data-v-c921ae33><p class="text-base font-bold text-sber-black" data-v-c921ae33>${ssrInterpolate((_f = unref(authStore).user) == null ? void 0 : _f.name)}</p>`);
      ...
      _push(`</div><p class="text-sm text-sber-gray" data-v-c921ae33>${ssrInterpolate((_h = unref(authStore).user) == null ? void 0 : _h.email)}</p>`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(aboutModal)) {
          _push2(`<div class="app-modal px-5 py-5" data-v-c921ae33><div class="text-center mb-6" data-v-c921ae33><div class="w-16 h-16 rounded-2xl bg-gradient-to-br from-sber-green to-sber-blue mx-auto mb-3 flex items-center justify-center" data-v-c921ae33><span class="text-white font-bold text-2xl" data-v-c921ae33>\u{1F9A6}</span></div><h3 class="text-lg font-bold" data-v-c921ae33>Otter</h3><p class="text-sm text-sber-gray" data-v-c921ae33>\u0412\u0435\u0440\u0441\u0438\u044F 1.0.0</p></div><div class="space-y-2" data-v-c921ae33><button class="w-full flex items-center gap-3 px-4 py-3 bg-sber-gray-light rounded-2xl" data-v-c921ae33>`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(comingSoonVisible)) {
          _push2(`<div class="fixed top-20 left-1/2 -translate-x-1/2 bg-sber-black text-white px-5 py-3 rounded-2xl text-sm font-medium z-50 shadow-lg text-center" data-v-c921ae33> \u0423\u0436\u0435 \u0440\u0430\u0437\u0440\u0430\u0431\u0430\u0442\u044B\u0432\u0430\u0435\u043C, \u0441\u043A\u043E\u0440\u043E \u0431\u0443\u0434\u0435\u0442 \u0433\u043E\u0442\u043E\u0432\u043E \u{1F60A} </div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
//# sourceMappingURL=settings-OchUcK1X.mjs.map
