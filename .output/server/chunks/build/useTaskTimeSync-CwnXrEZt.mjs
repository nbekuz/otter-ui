...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    __expose({
      focus: () => {
        var _a;
        return (_a = textRef.value) == null ? void 0 : _a.focus();
      }
    });
...
export { _sfc_main$1 as _, _sfc_main as a, useTaskTimeSync as u };
//# sourceMappingURL=useTaskTimeSync-CwnXrEZt.mjs.map
