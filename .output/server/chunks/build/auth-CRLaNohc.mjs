import { d as defineStore, e as useLocalStorage, l as apiGet, o as apiPut, p as apiPost, q as setAuthTokens, n as navigateTo } from './server.mjs';
...
const useAuthStore = defineStore("auth", () => {
  ...
  function mapBackendUser(nextUser) {
    ...
    return {
      ...
      isPremium: ((_a = user.value) == null ? void 0 : _a.isPremium) || false,
      premiumExpiresAt: (_b = user.value) == null ? void 0 : _b.premiumExpiresAt
    };
  }
  ...
  async function loginWithGoogle(payload) {
    var _a, _b, _c, _d;
    if (!(payload == null ? void 0 : payload.firebase_token)) {
    ...
    console.log("[otter:google] loginWithGoogle: javob keldi", {
      userId: (_a = response == null ? void 0 : response.user) == null ? void 0 : _a.id,
      email: (_b = response == null ? void 0 : response.user) == null ? void 0 : _b.email,
      hasAccess: !!((_c = response == null ? void 0 : response.tokens) == null ? void 0 : _c.access),
      hasRefresh: !!((_d = response == null ? void 0 : response.tokens) == null ? void 0 : _d.refresh)
    });
    setSession(response.user, response.tokens);
    await fetchMyProfile();
...
//# sourceMappingURL=auth-CRLaNohc.mjs.map
