...
import { w as workSoundOptions, s as soundOptions, d as defineStore, a as defaultPomodoroSettings } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex-1 text-left"><p class="text-xs text-sber-gray">\u0417\u0430\u0434\u0430\u0447\u0430 \u0434\u043B\u044F \u0444\u043E\u043A\u0443\u0441\u0430</p><p class="text-sm font-medium text-sber-black truncate">${ssrInterpolate(((_a = unref(selectedTask)) == null ? void 0 : _a.title) || "\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u0437\u0430\u0434\u0430\u0447\u0443...")}</p></div>`);
...
//# sourceMappingURL=pomodoro-CKHKf7xe.mjs.map
