import { _ as _sfc_main$2 } from './BrandLogo-D6nDDLEm.mjs';
...
import { a as useRoute, u as useSettingsStore } from './server.mjs';
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            _push2(`</div><p class="truncate text-xs text-sber-gray"${_scopeId}>${ssrInterpolate(((_g = unref(authStore).user) == null ? void 0 : _g.email) || "demo@otter.app")}</p></div></div>`);
          } else {
            return [
              ...
              createVNode("div", { class: "mt-4 flex items-center gap-3" }, [
                ...
                createVNode("div", { class: "min-w-0" }, [
                  ...
                  createVNode("p", { class: "truncate text-xs text-sber-gray" }, toDisplayString(((_n = unref(authStore).user) == null ? void 0 : _n.email) || "demo@otter.app"), 1)
                ])
              ])
            ];
          }
...
//# sourceMappingURL=app-Cf4fBQ3B.mjs.map
