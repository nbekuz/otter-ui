import { d as defineStore, e as useLocalStorage, m as mockTasks } from './server.mjs';
...
const useTasksStore = defineStore("tasks", () => {
  ...
  function searchTasks(query) {
    ...
    return tasks.value.filter(
      (t) => {
        var _a;
        return t.title.toLowerCase().includes(q) || ((_a = t.description) == null ? void 0 : _a.toLowerCase().includes(q));
      }
    );
  }
  return {
...
export { useTasksStore as u };
//# sourceMappingURL=tasks-BRvQftZO.mjs.map
