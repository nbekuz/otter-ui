  ...
  setup(__props) {
    ...
    const blocks = computed(() => {
      ...
      while (index < lines.length) {
        const rawLine = (_a = lines[index]) != null ? _a : "";
        ...
        if (line.startsWith("|")) {
          const tableLines = [];
          while (index < lines.length && ((_b = lines[index]) != null ? _b : "").trim().startsWith("|")) {
            tableLines.push(((_c = lines[index]) != null ? _c : "").trim());
            index += 1;
          }
        ...
        if (line.startsWith("- ")) {
          const items = [];
          while (index < lines.length) {
            const listLine = ((_d = lines[index]) != null ? _d : "").trim();
      ...
      if (((_e = result[0]) == null ? void 0 : _e.kind) === "h1") {
        result.shift();
      }
      return result;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(blocks), (block, index) => {
        ...
        _push(`<!--[-->`);
        if (block.kind === "h1") {
          _push(`<h1 class="text-lg font-bold text-sber-black">${(_a = block.html) != null ? _a : ""}</h1>`);
        } else if (block.kind === "h2") {
          _push(`<h2 class="pt-2 text-base font-semibold text-sber-black">${(_b = block.html) != null ? _b : ""}</h2>`);
        } else if (block.kind === "h3") {
          _push(`<h3 class="pt-1 text-sm font-semibold text-sber-black">${(_c = block.html) != null ? _c : ""}</h3>`);
        } else if (block.kind === "p") {
          _push(`<p class="whitespace-pre-wrap">${(_d = block.html) != null ? _d : ""}</p>`);
        } else if (block.kind === "list") {
          _push(`<ul class="list-disc space-y-2 pl-5"><!--[-->`);
          ssrRenderList(block.items, (item, itemIndex) => {
            _push(`<li>${item != null ? item : ""}</li>`);
          });
          _push(`<!--]--></ul>`);
          ...
          ssrRenderList(block.headers, (header, headerIndex) => {
            _push(`<th class="border border-sber-gray-light bg-sber-gray-light px-3 py-2 font-semibold text-sber-black">${header != null ? header : ""}</th>`);
          });
          _push(`<!--]--></tr></thead><tbody><!--[-->`);
          ssrRenderList(block.rows, (row, rowIndex) => {
            _push(`<tr><!--[-->`);
            ssrRenderList(row, (cell, cellIndex) => {
              _push(`<td class="border border-sber-gray-light px-3 py-2 align-top">${cell != null ? cell : ""}</td>`);
            });
            _push(`<!--]--></tr>`);
          });
...
//# sourceMappingURL=LegalDocumentBody-BpGf4Cv1.mjs.map
