...
import { defineComponent, ref, computed, mergeProps, unref, withCtx, openBlock, createBlock, toDisplayString, createVNode, resolveDynamicComponent, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderStyle, ssrRenderClass, ssrRenderVNode } from 'vue/server-renderer';
...
import { _ as _sfc_main$3 } from './TaskDetailModal-suNQDuqu.mjs';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            if (!((_a = unref(authStore).user) == null ? void 0 : _a.avatar)) {
              _push2(`<span class="text-white font-bold text-sm"${_scopeId}>${ssrInterpolate(((_d = (_c = (_b = unref(authStore).user) == null ? void 0 : _b.name) == null ? void 0 : _c[0]) == null ? void 0 : _d.toUpperCase()) || "A")}</span>`);
            } else {
...
//# sourceMappingURL=index-C08pjAvz.mjs.map
