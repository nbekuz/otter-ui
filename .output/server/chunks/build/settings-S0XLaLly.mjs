...
import { _ as _export_sfc, u as useAuthStore, b as useSettingsStore, e as useAppToast, d as useRoute, n as navigateTo, s as soundOptions, t as getApiErrorMessage } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div></div><div class="min-w-0 flex-1" data-v-f2022847><div class="flex items-center gap-2" data-v-f2022847><p class="truncate text-base font-bold text-sber-black" data-v-f2022847>${ssrInterpolate((_f = unref(authStore).user) == null ? void 0 : _f.name)}</p>`);
      ...
      _push(`</div><p class="truncate text-sm text-sber-gray" data-v-f2022847>${ssrInterpolate((_h = unref(authStore).user) == null ? void 0 : _h.email)}</p>`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(premiumModal)) {
          ...
          _push2(`<p class="text-center text-xs text-sber-gray mt-3" data-v-f2022847> \u041E\u043F\u043B\u0430\u0442\u0430 \u0447\u0435\u0440\u0435\u0437 \u0420\u043E\u0431\u043E\u043A\u0430\u0441\u0441\u0443. \u041F\u043E\u0441\u043B\u0435 \u043E\u043F\u043B\u0430\u0442\u044B \u043D\u0430\u0436\u043C\u0438\u0442\u0435 \xAB\u042F \u043E\u043F\u043B\u0430\u0442\u0438\u043B \u2014 \u0430\u043A\u0442\u0438\u0432\u0438\u0440\u043E\u0432\u0430\u0442\u044C\xBB. </p><button class="btn-secondary mt-2 w-full" type="button" data-v-f2022847>\u0417\u0430\u043A\u0440\u044B\u0442\u044C</button></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        if (unref(comingSoonVisible)) {
          _push2(`<div class="fixed top-20 left-1/2 -translate-x-1/2 bg-sber-black text-white px-5 py-3 rounded-2xl text-sm font-medium z-50 shadow-lg text-center" data-v-f2022847> \u0423\u0436\u0435 \u0440\u0430\u0437\u0440\u0430\u0431\u0430\u0442\u044B\u0432\u0430\u0435\u043C, \u0441\u043A\u043E\u0440\u043E \u0431\u0443\u0434\u0435\u0442 \u0433\u043E\u0442\u043E\u0432\u043E \u{1F60A} </div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
//# sourceMappingURL=settings-S0XLaLly.mjs.map
