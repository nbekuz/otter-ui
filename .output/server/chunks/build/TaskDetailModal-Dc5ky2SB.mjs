...
import { ssrRenderTeleport, ssrRenderStyle, ssrInterpolate, ssrRenderComponent, ssrRenderAttr, ssrRenderClass } from 'vue/server-renderer';
import { Calendar, Clock, Timer, RefreshCw, Bell, Paperclip, CheckCircle, Trash2, Save } from 'lucide-vue-next';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(task)) {
          ...
          _push2(`</div><div class="flex flex-col gap-2 px-4 pb-6"><button class="${ssrRenderClass([unref(task).completed ? "bg-sber-gray-light text-sber-gray" : "bg-sber-green-light text-sber-green", "flex items-center justify-center gap-2 rounded-2xl py-3.5 text-sm font-semibold transition-colors"])}" type="button">`);
          _push2(ssrRenderComponent(unref(CheckCircle), { class: "h-5 w-5" }, null, _parent));
          _push2(` ${ssrInterpolate(unref(task).completed ? "\u0412 \u0440\u0430\u0431\u043E\u0442\u0435" : "\u0412\u044B\u043F\u043E\u043B\u043D\u0435\u043D\u043E")}</button><button class="flex items-center justify-center gap-2 rounded-2xl bg-red-50 py-3.5 text-sm font-semibold text-red-500 transition-colors" type="button">`);
...
//# sourceMappingURL=TaskDetailModal-Dc5ky2SB.mjs.map
