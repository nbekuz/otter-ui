...
import { _ as _export_sfc, c as useTasksStore, f as defineStore, k as defaultPomodoroSettings, l as apiGet, q as apiPatch, r as apiPost } from './server.mjs';
...
function pauseBackgroundAudio() {
  backgroundAudio == null ? void 0 : backgroundAudio.pause();
}
...
function apiToPomodoroSettings(data) {
  ...
  return {
    ...
    shortBreak: (_a = data.short_break_minutes) != null ? _a : defaultPomodoroSettings.shortBreak,
...
const usePomodoroStore = defineStore("pomodoro", () => {
  ...
  function applySettingsResponse(data) {
    ...
    timerEndSoundDetail.value = (_a = data.timer_end_sound_detail) != null ? _a : null;
    workSoundDetail.value = (_b = data.work_sound_detail) != null ? _b : null;
  }
  function syncBackgroundAudio() {
    ...
    const url = (_a = workSoundDetail.value) == null ? void 0 : _a.audio_url;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="min-w-0 flex-1 text-left" data-v-d4710e3c><p class="text-xs text-sber-gray" data-v-d4710e3c>\u0417\u0430\u0434\u0430\u0447\u0430 \u0434\u043B\u044F \u0444\u043E\u043A\u0443\u0441\u0430</p><p class="truncate text-sm font-medium text-sber-black" data-v-d4710e3c>${ssrInterpolate(((_a = unref(selectedTask)) == null ? void 0 : _a.title) || "\u0412\u044B\u0431\u0440\u0430\u0442\u044C \u0437\u0430\u0434\u0430\u0447\u0443...")}</p></div>`);
...
//# sourceMappingURL=pomodoro-Bx92tIB5.mjs.map
