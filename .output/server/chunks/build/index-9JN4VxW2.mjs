...
import { _ as _sfc_main$4, P as PREMIUM_LANDING } from './SiteFooter-6gd8WARK.mjs';
import { _ as _sfc_main$3 } from './LegalAcceptanceText-Dy4o73JM.mjs';
import { l as logoUrl } from './logo-DVdZXLLs.mjs';
import { u as useAuthStore } from './server.mjs';
import './nuxt-link-B4h1IE6Y.mjs';
...
import 'node:crypto';
import 'node:url';
import './legal-static-BmX3fG1z.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full rounded-[24px] border border-yellow-200/80 bg-gradient-to-br from-yellow-50 via-white to-white px-5 py-5 shadow-sm md:px-6 md:py-6" }, _attrs))}><div class="flex items-start gap-4"><div class="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-yellow-100 text-yellow-700">`);
      _push(ssrRenderComponent(unref(Crown), { class: "h-6 w-6" }, null, _parent));
      _push(`</div><div class="min-w-0 flex-1"><p class="text-xs font-semibold uppercase tracking-wide text-yellow-700">${ssrInterpolate(unref(PREMIUM_LANDING).title)}</p><p class="mt-1 text-2xl font-bold text-sber-black md:text-3xl">${ssrInterpolate(unref(PREMIUM_LANDING).price)} \u20BD <span class="text-sm font-medium text-sber-gray">/ ${ssrInterpolate(unref(PREMIUM_LANDING).period)}</span></p><p class="mt-2 text-sm text-sber-gray"> \u0420\u0430\u0441\u0448\u0438\u0440\u0435\u043D\u043D\u044B\u0439 \u0434\u043E\u0441\u0442\u0443\u043F \u043A \u0440\u0430\u0437\u0434\u0435\u043B\u0430\u043C: </p><ul class="mt-3 space-y-2"><!--[-->`);
      ssrRenderList(unref(PREMIUM_LANDING).features, (feature) => {
        _push(`<li class="flex items-center gap-2 text-sm font-medium text-sber-black"><span class="flex h-5 w-5 shrink-0 items-center justify-center rounded-md bg-yellow-100 text-yellow-700">`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex min-h-dvh w-full flex-col overflow-x-hidden bg-white" }, _attrs))}><div class="flex flex-1 flex-col lg:items-center lg:justify-center lg:py-6"><div class="w-full px-4 pt-6 pb-8 md:px-8 md:pt-8 md:pb-10 lg:grid lg:grid-cols-[1.08fr_0.92fr] lg:items-stretch lg:gap-12 lg:px-10 lg:py-10 xl:gap-16 xl:px-14 2xl:px-20"><div class="flex w-full flex-1 flex-col items-center justify-start md:items-stretch lg:items-start lg:pt-0 lg:pb-2"><div class="relative mb-8 w-fit lg:origin-left lg:scale-110">`);
...
//# sourceMappingURL=index-9JN4VxW2.mjs.map
