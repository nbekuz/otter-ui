import { _ as _sfc_main$1 } from './TaskDetailModal-CTrbCuaM.mjs';
...
import { d as useRoute, c as useTasksStore, b as useSettingsStore } from './server.mjs';
import './useTaskTimeSync-v9DF83sN.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["page-container flex min-h-0 flex-col overflow-hidden max-lg:!min-h-0 max-lg:h-dvh max-lg:max-h-dvh lg:h-full lg:min-h-0 lg:pb-0", unref(isDarkTheme) ? "bg-[#0f1115]" : "bg-sber-gray-light"]
      }, _attrs))}><div class="${ssrRenderClass([unref(isDarkTheme) ? "bg-[#171a21] border-b border-[#2a303a]" : "bg-white shadow-sm", "page-header-top shrink-0 px-4 pb-4"])}"><div class="flex items-center justify-between"><h1 class="text-xl font-bold text-sber-black">\u041C\u0430\u0442\u0440\u0438\u0446\u0430 \u042D\u0439\u0437\u0435\u043D\u0445\u0430\u0443\u044D\u0440\u0430</h1><button class="${ssrRenderClass([unref(isDarkTheme) ? "bg-[#20242d]" : "bg-sber-gray-light", "w-9 h-9 rounded-xl flex items-center justify-center"])}">`);
      _push(ssrRenderComponent(unref(Settings), { class: "w-5 h-5 text-sber-gray" }, null, _parent));
      _push(`</button></div></div><div class="grid min-h-0 flex-1 grid-cols-2 grid-rows-2 gap-3 p-3" style="${ssrRenderStyle({ "grid-template-rows": "minmax(0, 1fr) minmax(0, 1fr)", "grid-template-columns": "minmax(0, 1fr) minmax(0, 1fr)" })}"><!--[-->`);
      ssrRenderList(unref(blocks), (block) => {
        _push(`<div class="flex h-full max-h-full min-h-0 flex-col overflow-hidden rounded-2xl border" style="${ssrRenderStyle(getBlockContainerStyle(block))}"><div class="border-b px-3 pt-3 pb-2" style="${ssrRenderStyle({ borderColor: block.color + "30" })}"><div class="mb-1 flex items-center justify-between gap-2"><div class="flex min-w-0 items-center gap-3"><div class="h-2.5 w-2.5 flex-shrink-0 rounded-full" style="${ssrRenderStyle({ backgroundColor: block.color })}"></div><p class="truncate pr-2 text-xs font-bold leading-tight" style="${ssrRenderStyle({ color: block.color })}">${ssrInterpolate(block.title)}</p></div><span class="text-[10px] font-medium px-2 py-0.5 rounded-full text-white" style="${ssrRenderStyle({ backgroundColor: block.color })}">${ssrInterpolate(getBlockTasks(block.id).length)}</span></div></div><div class="min-h-0 flex-1 overflow-y-auto overscroll-y-contain px-2 py-2"><div style="${ssrRenderStyle({ borderColor: block.color + "50", backgroundColor: unref(isDarkTheme) ? "#171a21" : block.bgColor })}" class="${ssrRenderClass([unref(dragTarget) === block.id ? unref(isDarkTheme) ? "bg-[#20242d]" : "bg-white/90" : "", "sticky top-0 z-20 mb-2 flex items-center justify-center rounded-xl border-2 border-dashed px-2 py-[5px] transition-colors"])}"><div class="flex items-center gap-1"><button type="button" class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg text-base font-bold leading-none transition-opacity active:opacity-60" style="${ssrRenderStyle({ color: block.color })}" aria-label="\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u0434\u0430\u0447\u0443"> + </button><span class="text-[10px]" style="${ssrRenderStyle({ color: block.color })}">${ssrInterpolate(unref(dragTarget) === block.id ? "\u041E\u0442\u043F\u0443\u0441\u0442\u0438\u0442\u0435 \u0437\u0434\u0435\u0441\u044C" : "\u043F\u0435\u0440\u0435\u0442\u0430\u0449\u0438\u0442\u0435")}</span></div></div><!--[-->`);
...
//# sourceMappingURL=matrix-Cbmr3ZYC.mjs.map
