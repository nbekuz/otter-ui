import { _ as __nuxt_component_1 } from './nuxt-link-B4X3mHvM.mjs';
import { defineComponent, computed, ref, watch, reactive, mergeProps, unref, withCtx, createVNode, nextTick, resolveDynamicComponent, useSSRContext } from 'vue';
...
import { AlertCircle, Sun, Sunset, Calendar, Clock, CheckCircle2, HelpCircle, FileText, Search, X, Check, Paperclip, CheckCircle, Trash2, Bell, RefreshCw, ChevronDown } from 'lucide-vue-next';
import dayjs from 'dayjs';
import { d as useRoute, u as useAuthStore, c as useTasksStore, b as useSettingsStore, n as navigateTo } from './server.mjs';
import { u as useTaskTimeSync, _ as _sfc_main$1$1, a as _sfc_main$3 } from './useTaskTimeSync-CwnXrEZt.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const greeting = computed(() => {
      if (hour < 16) return "\u0414\u043E\u0431\u0440\u043E\u0439 \u043D\u043E\u0447\u0438 \u{1F319}";
      if (hour < 12) return "\u0414\u043E\u0431\u0440\u043E\u0435 \u0443\u0442\u0440\u043E \u2600\uFE0F";
      if (hour < 18) return "\u0414\u043E\u0431\u0440\u044B\u0439 \u0434\u0435\u043D\u044C \u{1F324}";
      return "\u0414\u043E\u0431\u0440\u044B\u0439 \u0432\u0435\u0447\u0435\u0440 \u{1F319}";
    });
    ...
    function syncEditorForm(task) {
      ...
      editorForm.notification = (task == null ? void 0 : task.notification) || "";
      ...
      if (task == null ? void 0 : task.attachment) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="${ssrRenderClass([unref(isDarkTheme) ? "bg-[#0f1115]" : "bg-sber-gray-light", "page-header-top sticky top-0 z-20 px-4 pb-3 lg:px-6"])}"><div class="flex items-center justify-between mb-3"><div><p class="text-sm font-semibold text-sber-black">${ssrInterpolate(unref(greeting))}</p></div><div class="flex items-center gap-2">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(HelpCircle), { class: "h-5 w-5 text-sber-gray" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(unref(HelpCircle), { class: "h-5 w-5 text-sber-gray" })
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(unref(FileText), { class: "h-4 w-4 text-sber-gray" }, null, _parent2, _scopeId));
          } else {
            return [
              createVNode(unref(FileText), { class: "h-4 w-4 text-sber-gray" })
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`<button class="w-10 h-10 bg-white rounded-full shadow-sm flex items-center justify-center">`);
      ...
      if (unref(showSearch) && unref(searchQuery)) {
        ...
        if (unref(desktopSelectedTask)) {
          ...
          if (unref(attachmentName)) {
            _push(`<div class="mt-2 flex items-center gap-2 rounded-xl border border-sber-gray-light px-3 py-2"><p class="min-w-0 flex-1 truncate text-sm text-sber-black">${ssrInterpolate(unref(attachmentName))}</p><button type="button" class="text-sber-gray hover:text-red-500">`);
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(unsavedModal)) {
          _push2(`<div class="app-modal px-5 py-5"><h3 class="mb-2 text-lg font-bold text-sber-black">\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C \u0438\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u044F?</h3><p class="mb-5 text-sm text-sber-gray">\u0415\u0441\u0442\u044C \u043D\u0435\u0441\u043E\u0445\u0440\u0430\u043D\u0451\u043D\u043D\u044B\u0435 \u043F\u0440\u0430\u0432\u043A\u0438 \u0432 \u0437\u0430\u0434\u0430\u0447\u0435.</p><button class="btn-primary mb-2" type="button">\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C</button><button class="btn-secondary mb-2" type="button">\u041D\u0435\u0442</button><button class="w-full rounded-2xl py-4 text-sm font-semibold text-sber-gray" type="button">\u041E\u0442\u043C\u0435\u043D\u0430</button></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
//# sourceMappingURL=index-BDU-hVK4.mjs.map
