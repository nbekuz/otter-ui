import { _ as _sfc_main$1 } from './PremiumSubscriptionPanel-BTEAcrnF.mjs';
import { defineComponent, ref, reactive, computed, watch, mergeProps, unref, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderTeleport, ssrIncludeBooleanAttr } from 'vue/server-renderer';
import { ChevronLeft, Camera, Settings, ChevronRight, Crown, Image } from 'lucide-vue-next';
import { u as useAuthStore, c as useSettingsStore, f as usePremiumStore, g as useAppToast, B as BRAND_NAME, h as getApiErrorMessage } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c;
      const _component_PremiumSubscriptionPanel = _sfc_main$1;
      ...
      _push(`</div></button><div class="min-w-0 flex-1"><div class="flex flex-wrap items-center gap-2"><h2 class="truncate text-2xl font-bold text-sber-black">${ssrInterpolate(((_b = unref(authStore).user) == null ? void 0 : _b.name) || "\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044C")}</h2>`);
      ...
      _push(`</div><p class="mt-1 truncate text-sm text-sber-gray">${ssrInterpolate((_c = unref(authStore).user) == null ? void 0 : _c.email)}</p>`);
      ...
      _push(`<div class="flex-1"><p class="text-sm font-semibold text-sber-black">${ssrInterpolate(unref(BRAND_NAME))} Premium</p><p class="text-xs text-sber-gray">\u0420\u0430\u0441\u0448\u0438\u0440\u0435\u043D\u043D\u044B\u0435 \u0432\u043E\u0437\u043C\u043E\u0436\u043D\u043E\u0441\u0442\u0438 \u0438 \u0441\u0438\u043D\u0445\u0440\u043E\u043D\u0438\u0437\u0430\u0446\u0438\u044F</p></div>`);
      _push(ssrRenderComponent(unref(ChevronRight), { class: "h-4 w-4 text-sber-gray" }, null, _parent));
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(premiumModal)) {
          _push2(`<div class="app-modal px-5 py-6"><div class="text-center mb-4"><div class="mb-3 text-4xl">\u2B50</div><h3 class="text-xl font-bold text-sber-black">${ssrInterpolate(unref(BRAND_NAME))} Premium</h3></div>`);
...
//# sourceMappingURL=profile-Df8UDubc.mjs.map
