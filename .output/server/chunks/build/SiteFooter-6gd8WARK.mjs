...
import { S as STATIC_LEGAL_DOCUMENTS } from './legal-static-BmX3fG1z.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></ul></div></div><p class="mt-8 text-center text-xs text-sber-gray"> \xA9 ${ssrInterpolate(currentYear)} Otter. ${ssrInterpolate(unref(SITE_LEGAL_INFO).businessName)}</p></div></footer>`);
    };
  }
});
...
export { PREMIUM_LANDING as P, _sfc_main as _ };
//# sourceMappingURL=SiteFooter-6gd8WARK.mjs.map
