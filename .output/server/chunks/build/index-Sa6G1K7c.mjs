import { defineComponent, ref, computed, watch, reactive, mergeProps, unref, createVNode, resolveDynamicComponent, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderAttr, ssrRenderList, ssrRenderStyle, ssrRenderClass, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderVNode } from 'vue/server-renderer';
import { AlertCircle, Sun, Sunset, Calendar, Clock, CheckCircle2, Search, X, CheckCircle, Trash2, Check, Bell, RefreshCw, ChevronDown } from 'lucide-vue-next';
import dayjs from 'dayjs';
import { u as useAuthStore, b as useTasksStore, c as useSettingsStore, n as navigateTo } from './server.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$3 } from './TimeFieldRu-CPDZOlfK.mjs';
      ...
      if (unref(showSearch) && unref(searchQuery)) {
        ...
        ssrRenderList(unref(activeDesktopTasks), (task) => {
          ...
          if (task.notification) {
            _push(`<span>\u{1F514} ${ssrInterpolate(formatNotification(task.notification))}</span>`);
          } else {
            _push(`<!---->`);
          }
          if (task.repeat !== "none") {
...
//# sourceMappingURL=index-Sa6G1K7c.mjs.map
