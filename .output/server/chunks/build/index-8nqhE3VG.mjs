import { _ as _sfc_main$1 } from './BrandLogo-sBn3YHoU.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-dvh bg-white lg:flex lg:items-center lg:justify-center lg:bg-white lg:px-0 lg:py-0" }, _attrs))}><div class="w-full lg:grid lg:grid-cols-[1.08fr_0.92fr] lg:items-stretch lg:gap-16 lg:px-12 xl:px-20"><div class="flex flex-1 flex-col items-center justify-start px-6 pt-6 pb-8 lg:items-start lg:px-0 lg:pt-2 lg:pb-6"><div class="relative mb-8 w-fit lg:origin-left lg:scale-110">`);
      _push(ssrRenderComponent(_component_BrandLogo, {
        size: "lg",
        "show-name-from": "always",
        "text-class": "text-sber-black"
      }, null, _parent));
      _push(`<div class="pointer-events-none absolute -top-2 left-[calc(4rem-0.5rem)] h-6 w-6 rounded-full bg-sber-green/20"></div><div class="pointer-events-none absolute -bottom-1 -left-3 h-4 w-4 rounded-full bg-sber-blue/20"></div></div><p class="mb-2 max-w-2xl px-4 text-center text-lg leading-relaxed text-sber-gray lg:px-0 lg:text-left lg:text-2xl lg:leading-snug"> \u041F\u043B\u0430\u043D\u0438\u0440\u043E\u0432\u0449\u0438\u043A \u0437\u0430\u0434\u0430\u0447 \u0434\u043B\u044F \u0442\u0435\u0445, \u043A\u0442\u043E \u0446\u0435\u043D\u0438\u0442 \u0432\u0440\u0435\u043C\u044F </p><div class="mt-10 mb-4 grid w-full max-w-3xl grid-cols-1 gap-4 lg:mr-auto lg:max-w-[700px] lg:grid-cols-2 lg:gap-5"><!--[-->`);
      ssrRenderList(features, (feature) => {
        _push(`<div class="flex items-start gap-3 rounded-[24px] bg-sber-gray-light px-5 py-5 text-left shadow-sm transition-transform lg:min-h-[136px] lg:hover:-translate-y-0.5"><div class="${ssrRenderClass([feature.bg, "flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl text-xl"])}">${ssrInterpolate(feature.icon)}</div><div class="min-w-0"><p class="text-base font-semibold text-sber-black lg:text-lg">${ssrInterpolate(feature.title)}</p><p class="mt-1 text-sm leading-6 text-sber-gray lg:text-base">${ssrInterpolate(feature.text)}</p></div></div>`);
      });
      _push(`<!--]--></div><div class="mt-2 w-full max-w-3xl rounded-[24px] border border-sber-gray-mid/25 bg-white px-5 py-4 shadow-sm lg:mr-auto lg:max-w-[700px]"><p class="text-xs font-semibold uppercase tracking-wide text-sber-gray"> \u0412 \u043E\u0434\u043D\u043E\u043C \u043F\u0440\u0438\u043B\u043E\u0436\u0435\u043D\u0438\u0438 </p><ul class="mt-3 grid grid-cols-1 gap-2.5 sm:grid-cols-2"><!--[-->`);
      ...
      _push(`<!--]--><div class="pointer-events-none absolute left-1/2 top-1/2 z-10 flex h-20 w-20 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-sber-gray-light"><div class="flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-sm"><img${ssrRenderAttr("src", unref(logoUrl))} alt="Otter logo" class="h-8 w-8 brightness-0"></div></div></div><div class="mt-6 flex w-full flex-col items-center gap-3 lg:flex-row lg:flex-wrap lg:justify-center"><button class="btn-primary w-full max-w-[260px] lg:w-auto lg:min-w-[190px] lg:px-7" type="button"> \u0421\u043E\u0437\u0434\u0430\u0442\u044C \u0430\u043A\u043A\u0430\u0443\u043D\u0442 </button><button class="btn-outline w-full max-w-[260px] lg:w-auto lg:min-w-[160px] lg:px-7" type="button"> \u0412\u043E\u0439\u0442\u0438 </button><div class="flex w-full max-w-[260px] flex-col items-center gap-2 lg:w-auto lg:min-w-[220px]">`);
      if (unref(googleError)) {
        _push(`<p class="w-full text-center text-xs text-red-500">${ssrInterpolate(unref(googleError))}</p>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<button class="flex w-full items-center justify-center gap-3 rounded-2xl border border-sber-gray-mid bg-white py-4 font-semibold text-sber-black transition-colors active:bg-sber-gray-light disabled:cursor-not-allowed disabled:opacity-60" type="button"${ssrIncludeBooleanAttr(unref(googleLoading)) ? " disabled" : ""}><svg width="20" height="20" viewBox="0 0 24 24"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"></path><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"></path><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-.62z" fill="#FBBC05"></path><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"></path></svg> ${ssrInterpolate(unref(googleLoading) ? "\u0412\u0445\u043E\u0434\u2026" : "\u0412\u043E\u0439\u0442\u0438 \u0447\u0435\u0440\u0435\u0437 Google")}</button></div></div></div></div></div></div>`);
    };
  }
});
...
//# sourceMappingURL=index-8nqhE3VG.mjs.map
