import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, ref, markRaw, isRef, isReactive, toRaw, nextTick, onScopeDispose, watch, toRefs, computed, unref, onMounted, readonly, shallowRef, isReadonly, isShallow, defineComponent, createElementBlock, provide, cloneVNode, h, useSSRContext, defineAsyncComponent, Suspense, mergeProps, Fragment, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "/Users/nodirbek/Desktop/otter/otter-app/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/nodirbek/Desktop/otter/otter-app/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/nodirbek/Desktop/otter/otter-app/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/nodirbek/Desktop/otter/otter-app/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "/Users/nodirbek/Desktop/otter/otter-app/node_modules/defu/dist/defu.mjs";
import { hasProtocol, isScriptProtocol, joinURL, parseURL, encodePath, decodePath, withQuery } from "/Users/nodirbek/Desktop/otter/otter-app/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-9JN4VxW2.js")
  },
  {
    name: "login",
    path: "/login",
    component: () => import("./_nuxt/login-DiD7Gm6i.js")
  },
  {
    name: "matrix",
    path: "/matrix",
    component: () => import("./_nuxt/matrix-BDWLK3dr.js")
  },
  {
    name: "app-faq",
    path: "/app/faq",
    meta: __nuxt_page_meta$8 || {},
    component: () => import("./_nuxt/faq-PbXGyqJt.js")
  },
  {
    name: "calendar",
    path: "/calendar",
    component: () => import("./_nuxt/calendar-DSzma8iE.js")
  },
  {
    name: "pomodoro",
    path: "/pomodoro",
    component: () => import("./_nuxt/pomodoro-Cnvr7ZvG.js")
  },
  {
    name: "register",
    path: "/register",
    component: () => import("./_nuxt/register-Cl1EZUcP.js")
  },
  {
    name: "settings",
    path: "/settings",
    component: () => import("./_nuxt/settings-Bby5Ah3C.js")
  },
  {
    name: "app",
    path: "/app",
    meta: __nuxt_page_meta$7 || {},
    component: () => import("./_nuxt/index-DS192vMf.js")
  },
  {
    name: "app-legal",
    path: "/app/legal",
    meta: __nuxt_page_meta$6 || {},
    component: () => import("./_nuxt/legal-NFsr82Jk.js")
  },
  {
    name: "app-matrix",
    path: "/app/matrix",
    meta: __nuxt_page_meta$5 || {},
    component: () => import("./_nuxt/matrix-Cbmr3ZYC.js")
  },
  {
    name: "app-profile",
    path: "/app/profile",
    meta: __nuxt_page_meta$4 || {},
    component: () => import("./_nuxt/profile-Bydr__Bb.js")
  },
  {
    name: "app-calendar",
    path: "/app/calendar",
    meta: __nuxt_page_meta$3 || {},
    component: () => import("./_nuxt/calendar-DqERtExy.js")
  },
  {
    name: "app-new-task",
    path: "/app/new-task",
    meta: __nuxt_page_meta$2 || {},
    component: () => import("./_nuxt/new-task-Dk3n6wqr.js")
  },
  {
    name: "app-pomodoro",
    path: "/app/pomodoro",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/pomodoro-Bx92tIB5.js")
  },
  {
    name: "app-settings",
    path: "/app/settings",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/settings-S0XLaLly.js")
  },
  {
    name: "legal-slug",
    path: "/legal/:slug()",
    component: () => import("./_nuxt/_slug_-D1a9ZTtC.js")
  },
  {
    name: "profile-fill",
    path: "/profile-fill",
    component: () => import("./_nuxt/profile-fill-BL2Fk0Ls.js")
  }
];
...
async function refreshAccessToken() {
  ...
  const baseURL2 = resolveApiBaseUrl();
  const { data } = await axios.post(
    `${baseURL2}auth/token/refresh/`,
    { refresh },
...
const namedMiddleware = {
  auth: () => import("./_nuxt/auth-B7AEK2pI.js")
};
...
const layouts = {
  app: defineAsyncComponent(() => import("./_nuxt/app-xb-4vWOO.js").then((m) => m.default || m)),
  default: defineAsyncComponent(() => import("./_nuxt/default-DE7Yy99t.js").then((m) => m.default || m))
};
...
export {
  ...
  useAppToast as e,
  defineStore as f,
  getTaskScheduleStart as g,
  getTaskDurationMinutes as h,
  formatMinutesToTime as i,
  addMinutesToTime as j,
  defaultPomodoroSettings as k,
  apiGet as l,
  matrixBlockDefaults as m,
  navigateTo as n,
  onClickOutside as o,
  parseTimeToMinutes as p,
  apiPatch as q,
  apiPost as r,
  soundOptions as s,
  getApiErrorMessage as t,
  useAuthStore as u,
  tryUseNuxtApp as v,
  useRouter as w,
  defineNuxtRouteMiddleware as x,
  encodeRoutePath as y,
  resolveRouteObject as z
};
