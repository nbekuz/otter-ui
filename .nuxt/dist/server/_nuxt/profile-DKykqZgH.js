import { _ as _sfc_main$1 } from "./PremiumSubscriptionPanel-B3QXwiF0.js";
  ...
  setup(__props) {
    ...
    async function onPremiumCheckout(consent) {
      ...
      try {
        ...
        showToast("После оплаты нажмите «Я оплатил — активировать».", "success", 6e3);
      } catch (err) {
...
//# sourceMappingURL=profile-DKykqZgH.js.map
