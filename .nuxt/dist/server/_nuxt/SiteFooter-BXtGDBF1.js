...
import { S as SITE_LEGAL_INFO, B as BRAND_NAME } from "./site-info-a8Ok6ThT.js";
import { S as STATIC_LEGAL_DOCUMENTS } from "./legal-static-Djb9ie0o.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></ul></div></div><p class="mt-8 text-center text-xs text-sber-gray"> © ${ssrInterpolate(currentYear)} ${ssrInterpolate(unref(BRAND_NAME))}. ${ssrInterpolate(unref(SITE_LEGAL_INFO).businessName)}</p></div></footer>`);
    };
  }
});
...
//# sourceMappingURL=SiteFooter-BXtGDBF1.js.map
