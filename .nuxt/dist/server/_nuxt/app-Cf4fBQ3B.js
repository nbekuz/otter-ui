import { _ as _sfc_main$2 } from "./BrandLogo-D6nDDLEm.js";
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><p class="truncate text-xs text-sber-gray"${_scopeId}>${ssrInterpolate(unref(authStore).user?.email || "demo@otter.app")}</p></div></div>`);
          } else {
            return [
...
//# sourceMappingURL=app-Cf4fBQ3B.js.map
