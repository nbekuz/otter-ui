...
import { defineComponent, computed, ref, mergeProps, unref, useSSRContext, createVNode, resolveDynamicComponent, watch, reactive, withCtx, openBlock, createBlock, toDisplayString, nextTick } from "vue";
import { ssrRenderAttrs, ssrRenderStyle, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderVNode, ssrRenderList, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderTeleport } from "vue/server-renderer";
import { CheckCircle, Trash2, Check, Clock, Bell, RefreshCw, ChevronDown, AlertCircle, Sun, Sunset, Calendar, CheckCircle2, Search, X, Paperclip } from "lucide-vue-next";
import dayjs from "dayjs";
import { d as useTasksStore, e as useRoute, u as useAuthStore, c as useSettingsStore, n as navigateTo, r as resolveMediaUrl } from "../server.mjs";
import { u as useTaskTimeSync, _ as _sfc_main$3, a as _sfc_main$4 } from "./useTaskTimeSync-BMCBFEST.js";
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!unref(authStore).user?.avatar) {
              _push2(`<span class="text-sm font-bold text-white"${_scopeId}>${ssrInterpolate(unref(authStore).user?.name?.[0]?.toUpperCase() || "A")}</span>`);
            } else {
...
//# sourceMappingURL=index-J4qwnQM6.js.map
