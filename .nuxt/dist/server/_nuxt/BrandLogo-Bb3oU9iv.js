...
const logoUrl = "" + __buildAssetsURL("logo.CoqZcyhy.svg");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["inline-flex items-center gap-3", __props.centered ? "justify-center" : ""]
...
//# sourceMappingURL=BrandLogo-Bb3oU9iv.js.map
