...
import { toRef, isRef, defineComponent, reactive, ref, computed, mergeProps, withCtx, unref, createVNode, createTextVNode, useSSRContext } from "vue";
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (unref(showForgot)) {
          ...
          if (unref(forgotStep) === "email") {
            _push2(`<!--[--><p class="mb-4 text-sm text-sber-gray" data-v-2f0b4305> Введите email — мы отправим письмо с кодом (например: «ВАШ КОД 310696»). </p><div class="relative mb-2" data-v-2f0b4305>`);
...
//# sourceMappingURL=login-DKIeENk1.js.map
