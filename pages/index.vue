        ...
        <div class="rounded-[32px] bg-sber-gray-light p-6 lg:p-8">
          ...
          <div class="mt-6 grid max-w-[430px] grid-cols-2 gap-3">
            <div v-for="metric in metrics" :key="metric.label" class="rounded-2xl bg-white px-4 py-4 shadow-sm">
              ...
              <p class="mt-1 text-xs leading-5 text-sber-gray">{{ metric.text }}</p>
            </div>
          </div>
          ...
          <div class="mt-6 flex flex-col gap-3 lg:flex-row lg:flex-wrap lg:justify-center">
            ...
            <button class="btn-outline lg:w-auto lg:min-w-[160px] lg:px-7" type="button" @click="$router.push('/login')">
              Войти
            </button>
            <button
              class="flex w-full items-center justify-center gap-3 rounded-2xl border border-sber-gray-mid bg-white py-4 font-semibold text-sber-black transition-colors active:bg-sber-gray-light lg:w-auto lg:min-w-[220px] lg:px-7"
              type="button"
