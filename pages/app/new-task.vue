    ...
    <Teleport to="body">
      ...
      <Transition name="modal">
        <div v-if="deleteModal" class="app-modal px-5 py-5" @click.stop>
          ...
          <button class="btn-primary mb-2" type="button" @click="deleteTaskOccurrence">Удалить только этот повтор</button>
          <button class="btn-secondary mb-2" type="button" @click="deleteAllOccurrences">Удалить все повторения</button>
